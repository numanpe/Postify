...
export const dictionaries: Record<"en" | "ar", Dictionary> = {
  en: {
    ...
    onboarding: {
      ...
      extractionSourceHeuristic: "Basic extraction — no AI available for this yet. Add an API key or Free AI in Settings for a smarter summary.",
      extractionSourceAi: (providerName: string) => `Smarter summary generated by ${providerName}.`,
    ...
    brandKit: {
      ...
      extractionSourceHeuristic: "Basic extraction — no AI available for this yet. Add an API key or Free AI in Settings for a smarter summary.",
      extractionSourceAi: (providerName: string) => `Smarter summary generated by ${providerName}.`,
      bioTitle: "Link in bio page",
      bioSubtitle: "A simple public page with your logo, colors, description, and recent posts — a real link you can share anywhere (Instagram bio, WhatsApp, a business card).",
      bioEnabledLabel: "Make my link-in-bio page public",
      bioLinkLabel: "Your real link:",
      bioWebsiteLabel: "Website (optional)",
  ...
  ar: {
    ...
    onboarding: {
      ...
      extractionSourceHeuristic: "استخلاص أساسي — لا يتوفر ذكاء اصطناعي لهذا بعد. أضف مفتاح API أو استخدم الذكاء الاصطناعي المجاني في الإعدادات للحصول على ملخص أذكى.",
      extractionSourceAi: (providerName: string) => `تم إنشاء ملخص أذكى بواسطة ${providerName}.`,
    ...
    brandKit: {
      ...
      extractionSourceHeuristic: "استخلاص أساسي — لا يتوفر ذكاء اصطناعي لهذا بعد. أضف مفتاح API أو استخدم الذكاء الاصطناعي المجاني في الإعدادات للحصول على ملخص أذكى.",
      extractionSourceAi: (providerName: string) => `تم إنشاء ملخص أذكى بواسطة ${providerName}.`,
      bioTitle: "صفحة الرابط في السيرة الذاتية",
      bioSubtitle: "صفحة عامة بسيطة تعرض شعارك وألوانك ووصفك وأحدث منشوراتك — رابط حقيقي يمكنك مشاركته في أي مكان (السيرة الذاتية على إنستغرام، واتساب، بطاقة العمل).",
      bioEnabledLabel: "إتاحة صفحة الرابط الخاصة بي للعامة",
      bioLinkLabel: "رابطك الحقيقي:",
      bioWebsiteLabel: "الموقع الإلكتروني (اختياري)",
      bioWebsitePlaceholder: "https://yourbusiness.com",
